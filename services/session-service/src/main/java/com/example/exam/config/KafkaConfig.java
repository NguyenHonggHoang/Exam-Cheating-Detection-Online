...
/**
 * Kafka Configuration with Error Handling & Dead Letter Queue
 * 
 * Features:
...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.consumer.group-id:session-service}")
    ...
    public ProducerFactory<String, String> producerFactory() {
        ...
        // Idempotent producer to avoid duplicates in DLQ
